...
class CHF_Experiment:
    ...
    def plot_temp_diff_vs_thps_with_current(self):
        ...
        filename = os.path.join(
            self.save_path, "Temp_Diff_vs_Hot_Plate_Temperature_with_Current.png"
        )
    ...
    def plot_max_power_and_seebeck_coefficient_vs_thps(self):
        ...
        fig.tight_layout()
        filename = os.path.join(
            self.save_path, "Max_Power_and_Seebeck_Coefficient_vs_THP.png"
        )
        plt.savefig(filename, dpi=300)
...
if __name__ == "__main__":
    ...
    for system in ["S", "HC", "HH", "HM"]:
        ...
        print("=====================================")
        chf = CHF_Experiment(system=system, save_path=f"./{system}")
        print(chf.vhp_data)
        print(chf.tcp_data)
